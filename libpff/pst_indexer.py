...
def main(pst_file, report_name='PST Report'):
    """
    ...
    return HTMLReport(report_name, pst_name, top_word_list, top_sender_list)
...
def checkForMessages(folder):
    ...
    return folderReport(message_list, folder.name)
